...
import ex.openex.compile.expression.BoolExpression;
        ...
        if(buf.getType()==LexicalAnalysis.KEY){
            switch (buf.getData()) {
                ...
                case "if"->{
                    ...
                    BoolExpression e = new BoolExpression(vars,this,c);
                    try {
                        t = getToken();
            ...
            if(buf.getType()==LexicalAnalysis.KEY){
                switch (buf.getData()) {
                    ...
                    case "if"->{
                        ...
                        BoolExpression e = new BoolExpression(vars,parser,compiler);
                        try {
                            t = getToken();
                        }catch (EOFException e11){
